...
///////////////////////////////////////////////////////////////////////////////
class Item {
    constructor({name, imgUrl, id, faceId, price, storage, orderInfo}, containerId){
        this.price = price
...
// let inStock = items.map(item => item.orderInfo.inStock)
// console.log(inStock);
///////////////////////////////////
class Controller {
    constructor (items){
        ...
        this.inputMin.placeholder = "min price"
...
// myReduce (testArray, (value, item) => value + item);
